...
public class Q555 {
	public String splitLoopedString(String[] strs) {
		...
		if (left.compareTo(reverseLeft) >= 0 && left.compareTo(reverseRight) >= 0 && left.compareTo(right) >= 0) {
			next = left;
			direction = -1;
		}
		if (right.compareTo(reverseLeft) >= 0 && right.compareTo(reverseRight) >= 0 && right.compareTo(left) >= 0) {
			next = right;
			direction = 1;
		}
